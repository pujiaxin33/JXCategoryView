...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of JXCategoryView."
  ...
  s.homepage     = "http://EXAMPLE/JXCategoryView"
  ...
  s.author             = { "pjx" => "pujx@jingbo360.com" }
  ...
  s.source       = { :git => "http://EXAMPLE/JXCategoryView.git", :tag => "#{s.version}" }
